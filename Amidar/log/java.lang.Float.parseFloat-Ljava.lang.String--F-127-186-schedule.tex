...
\begin{document}
\sffamily
\begin{pspicture}[showgrid=false](-10.0,0)(104.0,82.0)
...
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](8.2,70.2)(12.8,75.2)
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](8.2,79.2)(12.799999999999999,79.8)
\rput(10.5,79.5){\large Out : 2 138:CONST:844(ind\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](8.2,75.2)(12.799999999999999,77.8)
\rput[lb](8.299999999999999,77.36666666666667){In0 : PE1.0 127:LOAD:4(re}
\rput[lb](8.299999999999999,76.93333333333334){In1 : PE1.1 129:LOAD:6}
\rput[lb](8.299999999999999,76.5){}
\rput(10.5,75.85000000000001){\large 131:DMA-LOAD(B)\normalsize}
...
\rput[lb](23.3,76.5){}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](28.2,30.2)(32.8,75.2)
...
\rput[lb](28.3,77.36666666666667){In0 : PE5.3 137:LOAD:3}
\rput[lb](28.3,76.93333333333334){In1 : PE1.2 138:CONST:844}
\rput[lb](28.3,76.5){}
\rput(30.5,75.85000000000001){\large 141:FDIV\normalsize}
...
\rput(10.5,70.85000000000001){\large 131:DMA-LOAD(B)\normalsize$\rightarrow$ 3}
...
\rput[lb](28.3,71.5){}
\rput(30.5,70.85000000000001){\large 141:FDIV\normalsize}
...
\rput(5.5,69.5){\large Out : 511 146:CONST:-1\normalsize}
...
\rput(10.5,69.5){\large Out : 3 131:DMA-LOAD(B)\normalsize$\rightarrow$ 3}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](8.2,65.2)(12.799999999999999,67.8)
\rput[lb](8.299999999999999,67.36666666666667){In0 : PE1.1 129:LOAD:6}
\rput[lb](8.299999999999999,66.93333333333334){In1 : PE0.511 146:CONST:-}
\rput[lb](8.299999999999999,66.5){}
\rput(10.5,65.85000000000001){\large 146:IADD\normalsize$\rightarrow$ 3}
\psline[linewidth=3pt]{->}(10.5,69.0)(15.5,68.0)\psframe[linewidth = 1.1pt](13.2,69.2)(17.799999999999997,69.8)
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](13.2,65.2)(17.799999999999997,67.8)
\rput[lb](13.299999999999999,67.36666666666667){In0 : PE1.3 131:DMA-LOAD(}
\rput[lb](13.299999999999999,66.93333333333334){In1 : PE2.302 132:CONST:4}
\rput[lb](13.299999999999999,66.5){}
\rput(15.5,65.85000000000001){\large 134:IFEQ\normalsize}
...
\rput[lb](28.3,66.5){}
\rput(30.5,65.85000000000001){\large 141:FDIV\normalsize}
...
\rput[lb](78.3,66.5){}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](83.2,65.2)(87.8,65.8)
\rput[lb](83.2,65.5){In1 : PE2 134:I $\rightarrow$ 0}
...
\rput[lb](8.299999999999999,62.36666666666667){In0 : PE1.0 127:LOAD:4(re}
\rput[lb](8.299999999999999,61.93333333333334){In1 : PE1.1 129:LOAD:6}
\rput[lb](8.299999999999999,61.5){}
\rput(10.5,60.85){\large 149:DMA-LOAD(B)\normalsize}
...
\rput[lb](28.3,61.5){}
\rput(30.5,60.85){\large 141:FDIV\normalsize}
...
\rput(85.5,63.5){\large0: 134:IFEQ\normalsize(0)}
...
\rput(10.5,55.85){\large 149:DMA-LOAD(B)\normalsize$\rightarrow$ 4}
...
\rput[lb](28.3,56.5){}
\rput(30.5,55.85){\large 141:FDIV\normalsize}
...
\rput(85.5,58.5){\large0: 134:IFEQ\normalsize(0)}
...
\rput(10.5,54.5){\large Out : 4 149:DMA-LOAD(B)\normalsize}
...
\rput[lb](8.299999999999999,52.36666666666667){In0 : PE1.0 127:LOAD:4(re}
\rput[lb](8.299999999999999,51.93333333333334){In1 : PE1.3 146:IADD}
\rput[lb](8.299999999999999,51.5){}
\rput(10.5,50.85){\large 160:CACHE-FETCH\normalsize}
\psline[linewidth=3pt]{->}(10.5,54.0)(15.5,53.0)\psframe[linewidth = 1.1pt](13.2,54.2)(17.799999999999997,54.800000000000004)
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](13.2,50.2)(17.799999999999997,52.800000000000004)
\rput[lb](13.299999999999999,52.36666666666667){In0 : PE1.4 149:DMA-LOAD(}
\rput[lb](13.299999999999999,51.93333333333334){In1 : PE2.304 150:CONST:4}
\rput[lb](13.299999999999999,51.5){}
\rput(15.5,50.85){\large 152:ISUB\normalsize$\rightarrow$ 0}
...
\rput[lb](28.3,51.5){}
\rput(30.5,50.85){\large 141:FDIV\normalsize}
...
\rput[lb](28.3,46.5){}
\rput(30.5,45.85){\large 141:FDIV\normalsize}
...
\rput[lb](33.300000000000004,47.36666666666667){In0 : PE2.0 152:ISUB}
\rput[lb](33.300000000000004,46.93333333333334){}
\rput[lb](33.300000000000004,46.5){}
\rput(35.5,45.85){\large 153:I2F\normalsize$\rightarrow$ 0}
...
\rput[lb](8.299999999999999,42.36666666666667){In0 : PE1.3 146:IADD}
\rput[lb](8.299999999999999,41.93333333333334){}
\rput[lb](8.299999999999999,41.5){}
\rput(10.5,40.85){\large 146:STORE:6\normalsize$\rightarrow$ 1}
...
\rput[lb](28.3,41.5){}
\rput(30.5,40.85){\large 141:FDIV\normalsize}
...
\rput(85.5,43.5){\large0: 134:IFEQ\normalsize(0)}
...
\rput[lb](28.3,36.5){}
\rput(30.5,35.85){\large 141:FDIV\normalsize}
...
\rput[lb](28.3,31.5){}
\rput(30.5,30.849999999999998){\large 141:FDIV\normalsize$\rightarrow$ 0}
...
\rput[lb](28.3,27.366666666666667){In0 : PE5.0 141:FDIV}
\rput[lb](28.3,26.933333333333334){In1 : PE6.0 153:I2F}
\rput[lb](28.3,26.5){}
\rput(30.5,25.849999999999998){\large 154:FADD\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](33.2,29.2)(37.800000000000004,29.8)
\rput(35.5,29.5){\large Out : 0 153:I2F\normalsize}
...
\rput[lb](28.3,21.5){}
\rput(30.5,20.849999999999998){\large 154:FADD\normalsize}
...
\rput[lb](28.3,16.5){}
\rput(30.5,15.85){\large 154:FADD\normalsize}
...
\rput[lb](28.3,11.5){}
\rput(30.5,10.85){\large 154:FADD\normalsize}
...
\rput[lb](28.3,6.5){}
\rput(30.5,5.8500000000000005){\large 154:FADD\normalsize}
...
\rput[lb](28.3,1.5){}
\rput(30.5,0.8500000000000001){\large 154:FADD\normalsize$\rightarrow$ 3}
...
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](63.2,80.2)(67.8,81.8)
\rput(65.7,81.0){\large PE 12\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](68.2,80.2)(72.8,81.8)
\rput(70.7,81.0){\large PE 13\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](73.2,80.2)(77.8,81.8)
\rput(75.7,81.0){\large PE 14\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](78.2,80.2)(82.8,81.8)
\rput(80.7,81.0){\large PE 15\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](83.2,80.2)(87.8,81.8)
\rput(85.7,81.0){\large C-Box\normalsize}
