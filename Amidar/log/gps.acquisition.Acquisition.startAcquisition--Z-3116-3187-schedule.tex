...
\begin{document}
\sffamily
\begin{pspicture}[showgrid=false](-10.0,0)(104.0,57.0)
...
\rput(10.5,54.5){\large Out : 267 3118:CONST:11\normalsize}
...
\rput(30.5,54.5){\large Out : 1 3116:LOAD:7\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](28.2,50.2)(32.8,52.800000000000004)
\rput[lb](28.3,52.36666666666667){In0 : PE5.1 3116:LOAD:7}
\rput[lb](28.3,51.93333333333334){In1 : PE1.267 3118:CONST:}
\rput[lb](28.3,51.5){}
\rput(30.5,50.85){\large 3120:IFGE\normalsize}
...
\rput(35.5,50.85){\large C3116:LOAD:7\normalsize$\rightarrow$ 0}
...
\rput[lb](83.2,50.5){In1 : PE5 3120: $\rightarrow$ 0}
...
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightred](8.2,40.2)(12.8,45.2)
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](8.2,49.2)(12.799999999999999,49.800000000000004)
\rput(10.5,49.5){\large Out : 257 3148:CONST:1\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightred](8.2,45.2)(12.799999999999999,47.800000000000004)
\rput[lb](8.299999999999999,47.36666666666667){In0 : PE1.0 3123:LOAD:5(r}
\rput[lb](8.299999999999999,46.93333333333334){In1 : PE5.1 3116:LOAD:7}
\rput[lb](8.299999999999999,46.5){}
\rput(10.5,45.85){\large 3127:DMA-LOAD(F\normalsize}
...
\rput(30.5,49.5){\large Out : 1 3116:LOAD:7\normalsize$\rightarrow$ 0}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](28.2,45.2)(32.8,47.800000000000004)
\rput[lb](28.3,47.36666666666667){In0 : PE5.1 3116:LOAD:7}
\rput[lb](28.3,46.93333333333334){In1 : PE1.257 3148:CONST:}
\rput[lb](28.3,46.5){}
\rput(30.5,45.85){\large 3148:IADD\normalsize$\rightarrow$ 0}
\psline[linewidth=3pt]{->}(30.5,49.0)(10.5,48.0)\psframe[linewidth = 1.1pt](33.2,49.2)(37.800000000000004,49.800000000000004)
...
\rput(85.5,48.5){\large0: 3120:IFGE\normalsize(0)}
...
\rput(10.5,40.85){\large 3127:DMA-LOAD(F\normalsize$\rightarrow$ 1}
...
\rput(30.5,44.5){\large Out : 0 3148:IADD\normalsize}
...
\rput[lb](28.3,41.5){}
\psline[linewidth=3pt]{->}(30.5,44.0)(35.5,43.0)\psframe[linewidth = 1.1pt](33.2,44.2)(37.800000000000004,44.800000000000004)
...
\rput(35.5,40.85){\large C3148:IADD\normalsize$\rightarrow$ 1}
...
\rput(85.5,43.5){\large0: 3120:IFGE\normalsize(0)}
...
\psframe[linewidth = 1.1pt,  fillstyle=vlines, hatchcolor=lightblue, fillcolor=lightblue](8.2,30.2)(12.8,35.2)
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](8.2,39.2)(12.799999999999999,39.800000000000004)
\rput(10.5,39.5){\large Out : 1 3127:DMA-LOAD(F)\normalsize}
...
\rput[lb](8.299999999999999,37.36666666666667){In0 : PE1.0 3123:LOAD:5(r}
\rput[lb](8.299999999999999,36.93333333333334){In1 : PE5.0 3148:IADD}
\rput[lb](8.299999999999999,36.5){}
\rput(10.5,35.85){\large 3162:CACHE-FETC\normalsize}
\psline[linewidth=3pt]{->}(10.5,39.0)(30.5,38.0)\psframe[linewidth = 1.1pt](13.2,39.2)(17.799999999999997,39.800000000000004)
...
\rput[lb](23.3,36.5){}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](28.2,20.2)(32.8,35.2)
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](28.2,39.2)(32.8,39.800000000000004)
\rput(30.5,39.5){\large Out : 0 3148:IADD\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](28.2,35.2)(32.8,37.800000000000004)
\rput[lb](28.3,37.36666666666667){In0 : PE1.1 3127:DMA-LOAD}
\rput[lb](28.3,36.93333333333334){In1 : PE5.2 3128:LOAD:3}
\rput[lb](28.3,36.5){}
\rput(30.5,35.85){\large 3129:FCMPL\normalsize}
...
\rput(35.5,39.5){\large Out : 1 3148:IADD\normalsize}
...
\psline[linewidth=3pt]{->}(35.5,39.0)(40.5,38.0)\psframe[linewidth = 1.1pt,  fillstyle=vlines, hatchcolor=lightblue, fillcolor=lightblue](38.2,30.2)(42.8,35.2)
...
\rput[lb](38.300000000000004,37.36666666666667){In0 : PE7.4 3142:LOAD:4(r}
\rput[lb](38.300000000000004,36.93333333333334){In1 : PE6.1 3148:IADD}
\rput[lb](38.300000000000004,36.5){}
\rput(40.5,35.85){\large 3181:CACHE-FETC\normalsize}
...
\rput(10.5,30.849999999999998){\large 3162:CACHE-FETC\normalsize}
...
\rput[lb](28.3,31.5){}
\rput(30.5,30.849999999999998){\large 3129:FCMPL\normalsize}
...
\rput(40.5,30.849999999999998){\large 3181:CACHE-FETC\normalsize}
...
\rput[lb](28.3,26.5){}
\rput(30.5,25.849999999999998){\large 3129:FCMPL\normalsize}
...
\rput[lb](28.3,21.5){}
\rput(30.5,20.849999999999998){\large 3129:FCMPL\normalsize$\rightarrow$ 3}
...
\rput(30.5,19.5){\large Out : 3 3129:FCMPL\normalsize}
...
\rput[lb](33.300000000000004,17.366666666666667){In0 : PE5.3 3129:FCMPL}
\rput[lb](33.300000000000004,16.933333333333334){In1 : PE6.256 3130:CONST:}
\rput[lb](33.300000000000004,16.5){}
\rput(35.5,15.85){\large 3130:IFLE\normalsize}
...
\rput[lb](78.3,16.5){}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](83.2,15.2)(87.8,15.799999999999999)
\rput[lb](83.2,15.5){In1 : PE6 3130: $\rightarrow$ 1}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightred](83.2,17.2)(87.8,19.8)
\rput(85.5,18.5){\large0: 3120:IFGE\normalsize(0)}
...
\rput(10.5,14.5){\large Out : 1 3127:DMA-LOAD(F)\normalsize}
...
\rput[lb](28.3,12.366666666666665){In0 : PE1.1 3127:DMA-LOAD}
\rput[lb](28.3,11.933333333333334){}
\rput[lb](28.3,11.5){}
\rput(30.5,10.85){\large 3138:STORE:3\normalsize$\rightarrow$ 2}
...
\rput(35.5,14.5){\large Out : 0 3116:LOAD:7\normalsize$\rightarrow$ 3}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightred](33.2,10.2)(37.800000000000004,12.799999999999999)
\rput[lb](33.300000000000004,12.366666666666665){In0 : PE6.0 3116:LOAD:7}
\rput[lb](33.300000000000004,11.933333333333334){}
\rput[lb](33.300000000000004,11.5){}
\rput(35.5,10.85){\large 3141:STORE:1\normalsize$\rightarrow$ 3}
\rput(37.57,10.43){\large 0\normalsize}
\psline[linewidth=3pt]{->}(35.5,14.0)(40.5,13.0)\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightred](38.2,5.2)(42.8,10.2)
...
\rput[lb](38.300000000000004,12.366666666666665){In0 : PE7.4 3142:LOAD:4(r}
\rput[lb](38.300000000000004,11.933333333333334){In1 : PE6.0 3116:LOAD:7}
\rput[lb](38.300000000000004,11.5){}
\rput(40.5,10.85){\large 3146:DMA-LOAD(I\normalsize}
...
\rput(85.5,13.5){\large0: 3130:IFLE\normalsize(1)}
...
\rput(40.5,5.8500000000000005){\large 3146:DMA-LOAD(I\normalsize$\rightarrow$ 5}
...
\rput(85.5,8.5){\large0: 3130:IFLE\normalsize(1)}
...
\rput[lb](28.3,2.3666666666666667){In0 : PE5.0 3148:IADD}
\rput[lb](28.3,1.9333333333333333){}
\rput[lb](28.3,1.5){}
\rput(30.5,0.8500000000000001){\large 3148:STORE:7\normalsize$\rightarrow$ 1}
...
\rput(85.5,3.5){\large0: 3120:IFGE\normalsize(0)}
...
\rput(1.5,2.5){\large10\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](3.2,55.2)(7.8,56.8)
\rput(5.7,56.0){\large PE 0\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](8.2,55.2)(12.8,56.8)
\rput(10.7,56.0){\large PE 1\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](13.2,55.2)(17.8,56.8)
\rput(15.7,56.0){\large PE 2\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](18.2,55.2)(22.8,56.8)
\rput(20.7,56.0){\large PE 3\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](23.2,55.2)(27.8,56.8)
\rput(25.7,56.0){\large PE 4\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](28.2,55.2)(32.8,56.8)
\rput(30.7,56.0){\large PE 5\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](33.2,55.2)(37.8,56.8)
\rput(35.7,56.0){\large PE 6\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](38.2,55.2)(42.8,56.8)
\rput(40.7,56.0){\large PE 7\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](43.2,55.2)(47.8,56.8)
\rput(45.7,56.0){\large PE 8\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](48.2,55.2)(52.8,56.8)
\rput(50.7,56.0){\large PE 9\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](53.2,55.2)(57.8,56.8)
\rput(55.7,56.0){\large PE 10\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](58.2,55.2)(62.8,56.8)
\rput(60.7,56.0){\large PE 11\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](63.2,55.2)(67.8,56.8)
\rput(65.7,56.0){\large PE 12\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](68.2,55.2)(72.8,56.8)
\rput(70.7,56.0){\large PE 13\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](73.2,55.2)(77.8,56.8)
\rput(75.7,56.0){\large PE 14\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](78.2,55.2)(82.8,56.8)
\rput(80.7,56.0){\large PE 15\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](83.2,55.2)(87.8,56.8)
\rput(85.7,56.0){\large C-Box\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](-0.8,54.8)(-0.2,0.2)
\end{pspicture}
\end{document}