...
\begin{document}
\sffamily
\begin{pspicture}[showgrid=false](-10.0,0)(104.0,77.0)
...
\rput(10.5,74.5){\large Out : 257 32:CONST:1\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](8.2,70.2)(12.799999999999999,72.8)
\rput[lb](8.299999999999999,72.36666666666667){In0 : PE1.0 10:LOAD:0(ref}
\rput[lb](8.299999999999999,71.93333333333334){In1 : PE1.258 32:CONST:2}
\rput[lb](8.299999999999999,71.5){}
\rput(10.5,70.85000000000001){\large 11:DMA-LOAD\normalsize}
...
\rput(30.5,74.5){\large Out : 1 9:LOAD:2\normalsize$\rightarrow$ 0}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](28.2,70.2)(32.8,72.8)
\rput[lb](28.3,72.36666666666667){In0 : PE5.1 9:LOAD:2}
\rput[lb](28.3,71.93333333333334){In1 : PE1.257 32:CONST:1}
\rput[lb](28.3,71.5){}
\rput(30.5,70.85000000000001){\large 32:IADD\normalsize$\rightarrow$ 0}
...
\rput(35.5,70.85000000000001){\large C9:LOAD:2\normalsize$\rightarrow$ 0}
...
\rput(10.5,65.85000000000001){\large 11:DMA-LOAD\normalsize$\rightarrow$ 1}
...
\rput(30.5,69.5){\large Out : 0 32:IADD\normalsize}
...
\rput(35.5,65.85000000000001){\large C32:IADD\normalsize$\rightarrow$ 1}
...
\rput(10.5,64.5){\large Out : 1 11:DMA-LOAD\normalsize}
...
\rput[lb](28.3,62.36666666666667){In0 : PE5.1 9:LOAD:2}
\rput[lb](28.3,61.93333333333334){In1 : PE1.1 11:DMA-LOAD}
\rput[lb](28.3,61.5){}
\rput(30.5,60.85){\large 14:IFGE\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](33.2,64.2)(37.800000000000004,64.8)
\rput(35.5,64.5){\large Out : 1 32:IADD\normalsize}
...
\psline[linewidth=3pt]{->}(35.5,64.0)(40.5,63.0)\psframe[linewidth = 1.1pt,  fillstyle=vlines, hatchcolor=lightblue, fillcolor=lightblue](38.2,55.2)(42.8,60.2)
...
\rput[lb](38.300000000000004,62.36666666666667){In0 : PE7.2 17:LOAD:1(ref}
\rput[lb](38.300000000000004,61.93333333333334){In1 : PE6.1 32:IADD}
\rput[lb](38.300000000000004,61.5){}
\rput(40.5,60.85){\large 57:CACHE-FETCH(\normalsize}
...
\rput[lb](83.2,60.5){In1 : PE5 14:IF $\rightarrow$ 0}
...
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightred](8.2,50.2)(12.8,55.2)
...
\rput[lb](8.299999999999999,57.36666666666667){In0 : PE1.0 10:LOAD:0(ref}
\rput[lb](8.299999999999999,56.93333333333334){In1 : PE1.259 24:CONST:3}
\rput[lb](8.299999999999999,56.5){}
\rput(10.5,55.85){\large 24:DMA-LOAD\normalsize}
...
\psframe[linewidth = 1.1pt,  fillstyle=vlines, hatchcolor=lightblue, fillcolor=lightblue](38.2,55.2)(42.800000000000004,57.800000000000004)
\rput[lb](38.300000000000004,57.36666666666667){}
\rput[lb](38.300000000000004,56.93333333333334){}
\rput[lb](38.300000000000004,56.5){}
\rput(40.5,55.85){\large 57:CACHE-FETCH(\normalsize}
...
\rput[lb](43.300000000000004,57.36666666666667){In0 : PE8.0 10:LOAD:0(ref}
\rput[lb](43.300000000000004,56.93333333333334){In1 : PE8.256 20:CONST:0}
\rput[lb](43.300000000000004,56.5){}
\rput(45.5,55.85){\large 20:DMA-LOAD(ref\normalsize}
...
\rput(10.5,50.85){\large 24:DMA-LOAD\normalsize$\rightarrow$ 1}
...
\rput(45.5,50.85){\large 20:DMA-LOAD(ref\normalsize$\rightarrow$ 1}
...
\rput(10.5,49.5){\large Out : 1 24:DMA-LOAD\normalsize}
...
\psline[linewidth=3pt]{->}(10.5,49.0)(15.5,48.0)\psline[linewidth=3pt]{->}(10.5,49.0)(30.5,48.0)\psframe[linewidth = 1.1pt](13.2,49.2)(17.799999999999997,49.800000000000004)
...
\rput(15.5,45.85){\large C24:DMA-LOAD\normalsize$\rightarrow$ 0}
...
\rput[lb](23.3,46.5){}
\rput(25.5,45.85){\large C20:DMA-LOAD(re\normalsize$\rightarrow$ 0}
...
\rput[lb](28.3,47.36666666666667){In0 : PE1.1 24:DMA-LOAD}
\rput[lb](28.3,46.93333333333334){In1 : PE5.1 9:LOAD:2}
\rput[lb](28.3,46.5){}
\rput(30.5,45.85){\large 28:IADD\normalsize$\rightarrow$ 2}
...
\rput(45.5,49.5){\large Out : 1 20:DMA-LOAD(ref)\normalsize}
...
\rput(5.5,40.85){\large C20:DMA-LOAD(re\normalsize$\rightarrow$ 0}
...
\rput(15.5,44.5){\large Out : 0 24:DMA-LOAD\normalsize}
...
\rput(25.5,44.5){\large Out : 0 20:DMA-LOAD(ref)\normalsize}
...
\psframe[linewidth = 1.1pt,  fillstyle=vlines, hatchcolor=lightblue, fillcolor=lightblue](33.2,40.2)(37.800000000000004,42.800000000000004)
\rput[lb](33.300000000000004,42.36666666666667){In0 : PE2.0 24:DMA-LOAD}
\rput[lb](33.300000000000004,41.93333333333334){In1 : PE6.1 32:IADD}
\rput[lb](33.300000000000004,41.5){}
\rput(35.5,40.85){\large 54:IADD\normalsize$\rightarrow$ 1}
...
\rput(10.5,35.85){\large C20:DMA-LOAD(re\normalsize$\rightarrow$ 1}
\psframe[linewidth = 1.1pt](13.2,39.2)(17.799999999999997,39.800000000000004)
\psframe[linewidth = 1.1pt,  fillstyle=vlines, hatchcolor=lightblue, fillcolor=lightgray](13.2,35.2)(17.799999999999997,37.800000000000004)
\rput[lb](13.299999999999999,37.36666666666667){}
\rput[lb](13.299999999999999,36.93333333333334){}
\rput[lb](13.299999999999999,36.5){}
\rput(15.5,35.85){\large C54:IADD\normalsize$\rightarrow$ 0}
...
\rput(35.5,39.5){\large Out : 1 54:IADD\normalsize}
...
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightred](8.2,25.2)(12.8,30.2)
...
\rput[lb](8.299999999999999,32.36666666666667){In0 : PE1.1 20:DMA-LOAD(r}
\rput[lb](8.299999999999999,31.933333333333334){In1 : PE5.2 28:IADD}
\rput[lb](8.299999999999999,31.5){}
\rput(10.5,30.849999999999998){\large 29:DMA-LOAD(C)\normalsize}
...
\rput(30.5,34.5){\large Out : 2 28:IADD\normalsize}
...
\rput(10.5,25.849999999999998){\large 29:DMA-LOAD(C)\normalsize$\rightarrow$ 2}
...
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](8.2,24.2)(12.799999999999999,24.8)
\rput(10.5,24.5){\large Out : 2 29:DMA-LOAD(C)\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=vlines, hatchcolor=lightblue, fillcolor=lightblue](8.2,20.2)(12.799999999999999,22.8)
\rput[lb](8.299999999999999,22.366666666666667){In0 : PE1.1 20:DMA-LOAD(r}
\rput[lb](8.299999999999999,21.933333333333334){In1 : PE2.0 54:IADD}
\rput[lb](8.299999999999999,21.5){}
\rput(10.5,20.849999999999998){\large 55:CACHE-FETCH(\normalsize}
\psline[linewidth=3pt]{->}(10.5,24.0)(30.5,23.0)\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](13.2,24.2)(17.799999999999997,24.8)
\rput(15.5,24.5){\large Out : 0 54:IADD\normalsize}
...
\rput[lb](28.3,22.366666666666667){In0 : PE1.2 29:DMA-LOAD(C}
\rput[lb](28.3,21.933333333333334){}
\rput[lb](28.3,21.5){}
\rput(30.5,20.849999999999998){\large 30:I2B\normalsize$\rightarrow$ 2}
...
\rput(10.5,15.85){\large 55:CACHE-FETCH(\normalsize}
...
\rput(30.5,19.5){\large Out : 2 30:I2B\normalsize}
...
\rput(35.5,14.5){\large Out : 1 30:I2B\normalsize}
...
\rput(35.5,9.5){\large Out : 0 9:LOAD:2\normalsize}
...
\rput[lb](38.300000000000004,7.366666666666667){In0 : PE7.2 17:LOAD:1(ref}
\rput[lb](38.300000000000004,6.933333333333334){In1 : PE6.0 9:LOAD:2}
\rput[lb](38.300000000000004,6.5){In2 : PE7.0 30:I2B}
\rput(40.5,5.8500000000000005){\large 31:DMA-STORE(B)\normalsize}
...
\rput[lb](28.3,2.3666666666666667){In0 : PE5.0 32:IADD}
\rput[lb](28.3,1.9333333333333333){}
\rput[lb](28.3,1.5){}
\rput(30.5,0.8500000000000001){\large 32:STORE:2\normalsize$\rightarrow$ 1}
...
\rput(1.5,2.5){\large14\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](3.2,75.2)(7.8,76.8)
\rput(5.7,76.0){\large PE 0\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](8.2,75.2)(12.8,76.8)
\rput(10.7,76.0){\large PE 1\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](13.2,75.2)(17.8,76.8)
\rput(15.7,76.0){\large PE 2\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](18.2,75.2)(22.8,76.8)
\rput(20.7,76.0){\large PE 3\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](23.2,75.2)(27.8,76.8)
\rput(25.7,76.0){\large PE 4\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](28.2,75.2)(32.8,76.8)
\rput(30.7,76.0){\large PE 5\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](33.2,75.2)(37.8,76.8)
\rput(35.7,76.0){\large PE 6\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](38.2,75.2)(42.8,76.8)
\rput(40.7,76.0){\large PE 7\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](43.2,75.2)(47.8,76.8)
\rput(45.7,76.0){\large PE 8\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](48.2,75.2)(52.8,76.8)
\rput(50.7,76.0){\large PE 9\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](53.2,75.2)(57.8,76.8)
\rput(55.7,76.0){\large PE 10\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](58.2,75.2)(62.8,76.8)
\rput(60.7,76.0){\large PE 11\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](63.2,75.2)(67.8,76.8)
\rput(65.7,76.0){\large PE 12\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](68.2,75.2)(72.8,76.8)
\rput(70.7,76.0){\large PE 13\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](73.2,75.2)(77.8,76.8)
\rput(75.7,76.0){\large PE 14\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightgray](78.2,75.2)(82.8,76.8)
\rput(80.7,76.0){\large PE 15\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](83.2,75.2)(87.8,76.8)
\rput(85.7,76.0){\large C-Box\normalsize}
\psframe[linewidth = 1.1pt,  fillstyle=solid, fillcolor=lightblue](-0.8,74.8)(-0.2,0.2)
\end{pspicture}
\end{document}